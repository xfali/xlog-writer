...
func ZipLogsAsyncWithLevel(compressLevel int) func(dir string, name string, files ...string) error {
	return func(dir string, name string, files ...string) error {
		go zipLogs(compressLevel, dir, name, files...)
		return nil
	}
}

func ZipLogsWithLevel(compressLevel int) func(dir string, name string, files ...string) error {
	return func(dir string, name string, files ...string) error {
		return zipLogs(compressLevel, dir, name, files...)
	}
}
...
func ZipLogs(dir string, name string, files ...string) error {
	return zipLogs(5, dir, name, files...)
}

func zipLogs(compressLevel int, dir string, name string, files ...string) error {
	if len(files) == 0 {
		return nil
	}
